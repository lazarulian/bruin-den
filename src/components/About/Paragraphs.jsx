    ...
    <div className='bg-white grid grid-cols-2 gap-1 p-10 font-serif'>
        <div className= 'col col-span-1 text-center p-10'>
            ...
            <p> Housing insecurity is a particularly pressing issue for
                 ...
                 groups. Studies have shown that these populations are 
                 disproportionately likely to experience homelessness,
                discrimination in the housing market, and other forms 
                of housing insecurity. This can be due to a variety of
